...
class KehilanganKtpController extends Controller
{
    public function index()
    {
        ...
        return view('setting.kehilanganktp.index', compact('data'));
    }

    public function create()
    {
        return view('setting.kehilanganktp.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('setting.kehilanganktp.show', compact('data'));
    }

    public function edit($id)
    {
        $data = KehilanganKtp::findOrFail($id);
        return view('setting.kehilanganktp.edit', compact('data'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin.kehilanganktp.index')->with('success', 'Laporan kehilangan KTP berhasil diperbarui');
    }
